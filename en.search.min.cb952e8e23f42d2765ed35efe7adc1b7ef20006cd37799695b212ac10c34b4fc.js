...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c704e7e057762ffb19b96801eceeed1b5d256de5cd50b31d9736ce253fcbcd2d.js',function(){input.required=false;search();});}
